        ...
        for (i = 0;i < VON_MISES_NB_STEP;i++) {
          ...
          for (j = 0;j < nb_state;j++) {
            os << "\t" << exp(observation[j]->dispersion * cos((value - observation[j]->location) * M_PI / 180)) /
                          (360 * boost::math::cyl_bessel_i(0 , observation[j]->dispersion));
          }
          value += step;
          os << endl;
        }
        ...
        for (i = 0;i < VON_MISES_NB_STEP;i++) {
          ...
          for (j = 0;j < nb_state;j++) {
            os << "\t" << exp(observation[j]->dispersion * cos(value - observation[j]->location)) /
                          (2 * M_PI * boost::math::cyl_bessel_i(0 , observation[j]->dispersion));
          }
          value += step;
          os << endl;
        }
        ...
        case DEGREE : {
          for (j = 0;j < nb_step;j++) {
            frequency[i][j] = exp(observation[i]->dispersion * cos((value - observation[i]->location) * M_PI / 180)) /
                              (360 * boost::math::cyl_bessel_i(0 , observation[i]->dispersion));
            value += step;
          }
          break;
        }
        ...
        case RADIAN : {
          for (j = 0;j < nb_step;j++) {
            frequency[i][j] = exp(observation[i]->dispersion * cos(value - observation[i]->location)) /
                              (2 * M_PI * boost::math::cyl_bessel_i(0 , observation[i]->dispersion));
            value += step;
          }
          break;
        }
